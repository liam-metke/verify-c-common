 ...
 * additionally entry_count is always true since pre-condition that
 * map->entry_count matches actually non-empty slots is too expensive to check
 */
